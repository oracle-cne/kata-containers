...
Summary:      Kata Containers 4.2.0 runtime, guest agent, and rootfs image
Url:	      https://%{download}
...
%description
Kata Containers 4.2.0. Kata Containers is an open source
...
# The 4.2.0 component Makefiles are invoked from their own directories but
...
#agent
pushd src/agent
echo "RPM build: building the 4.2.0 guest agent"
...
echo "RPM build: building the 4.2.0 guest initrd and rootfs image"
...
%changelog
* Tue Sep 15 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 4.2.0-1
